...
#     university    = serializers.CharField(max_length=300, required=True)
#     student_num   = serializers.CharField(max_length=50, required=False, allow_blank=True, allow_null=True)
...
#     phone_num     = serializers.CharField(max_length=50, required=False, allow_blank=True, allow_null=True) 
...
#     gender        = serializers.ChoiceField(choices=GENDERS, required=False, allow_blank=True, allow_null=True)
#     post_code     = serializers.CharField(max_length=5, required=False, allow_blank=True, allow_null=True)
